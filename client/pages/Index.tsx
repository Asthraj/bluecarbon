    ...
    <div className="bg-gradient-to-b from-blue-50 to-background">
      ...
      <section className="container relative flex min-h-[72vh] flex-col items-center justify-center py-16 text-center">
        ...
        <h1 className="max-w-4xl bg-gradient-to-b from-primary to-emerald-600 bg-clip-text text-4xl font-extrabold leading-tight tracking-tight text-transparent md:text-6xl">
          Blockchain-powered Registry for Coastal Restoration & Tokenized Credits
        </h1>
        <p className="mt-4 max-w-2xl text-balance text-base text-muted-foreground md:text-lg">
          An end-to-end MRV platform that immutably stores verified plantation data,
          tokenizes carbon credits, onboards NGOs and communities, and ingests field data from mobile apps and drones.
        </p>
          ...
          <div className="rounded-xl border bg-card p-6 shadow-sm">
            <ol className="space-y-4 text-sm">
              <li className="flex gap-3">
                <span className="mt-0.5 inline-flex h-6 w-6 items-center justify-center rounded-full bg-primary text-primary-foreground">1</span>
                <div>
                  <div className="font-semibold">Collect field data</div>
                  <p className="text-muted-foreground">Mobile app and drones capture geo-tagged imagery and measurements.</p>
                </div>
              </li>
              <li className="flex gap-3">
                <span className="mt-0.5 inline-flex h-6 w-6 items-center justify-center rounded-full bg-primary text-primary-foreground">2</span>
                <div>
                  <div className="font-semibold">Verify & attest</div>
                  <p className="text-muted-foreground">Automated checks with expert review produce an immutable attestation.</p>
                </div>
              </li>
              <li className="flex gap-3">
                <span className="mt-0.5 inline-flex h-6 w-6 items-center justify-center rounded-full bg-primary text-primary-foreground">3</span>
                <div>
                  <div className="font-semibold">Mint credits</div>
                  <p className="text-muted-foreground">Smart contracts tokenize credits, assign to wallets, and enable retirement.</p>
                </div>
              </li>
              <li className="flex gap-3">
                <span className="mt-0.5 inline-flex h-6 w-6 items-center justify-center rounded-full bg-primary text-primary-foreground">4</span>
                <div>
                  <div className="font-semibold">Public registry</div>
                  <p className="text-muted-foreground">Projects and credits are discoverable and traceable by anyone.</p>
                </div>
              </li>
            </ol>
          </div>
          <div className="space-y-4">
            <h3 className="text-2xl font-bold">Open, verifiable, and tamper-proof</h3>
            <p className="text-muted-foreground">
              Designed with NCCR and coastal stakeholders, BlueCarbonMRV ensures accountability across the lifecycle—planting, verification, credit issuance, and retirement.
            </p>
      ...
      <section className="container py-20">
        <div className="relative overflow-hidden rounded-2xl border bg-gradient-to-br from-primary to-emerald-600 p-8 text-primary-foreground">
          ...
          <h3 className="text-2xl font-bold">Start contributing to India’s blue carbon future</h3>
          <p className="mt-1 max-w-2xl text-primary-foreground/90">
            Upload field data, verify restoration, and mint trusted carbon credits.
          </p>
...
function Feature({ title, desc }: { title: string; desc: string }) {
  return (
    <div className="rounded-xl border bg-card p-6 shadow-sm">
      <div className="mb-2 h-10 w-10 rounded-md bg-primary/10 text-primary inline-flex items-center justify-center font-bold">★</div>
