    ...
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      <header className="sticky top-0 z-40 w-full border-b bg-white/70 backdrop-blur supports-[backdrop-filter]:bg-white/40 dark:bg-sidebar-background/60">
        <div className="container flex h-16 items-center justify-between">
          ...
          >
            <span className="h-8 w-8 rounded-md bg-gradient-to-br from-primary to-accent inline-flex items-center justify-center text-primary-foreground shadow-md">
              BC
            </span>
      ...
      <footer className="border-t bg-card">
        <div className="container py-8 text-sm text-muted-foreground flex flex-col md:flex-row items-center justify-between gap-4">
          <p>
            © {new Date().getFullYear()} BlueCarbonMRV · National Centre for
            Coastal Research
          </p>
